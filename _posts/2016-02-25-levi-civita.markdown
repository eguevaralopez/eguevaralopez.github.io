...
Now, if we set $n=k$ in equation (1) we get
...
Setting $m=j$ in equation (2) yields
...
$$
\epsilon_{ijk}\epsilon^{ljk}=2\delta_{i}^{l}\tag{3}
$$

Letting the last set of indices be the same in equation (3), the final Levi-Civita identity is obtained

$$
\epsilon_{ijk}\epsilon^{ijk}=6\tag{4}
$$
