...
{: refdef}
{:refdef2: style="text-align: right;"}
...the **PCPartner BXAS13-948C**
{: refdef2}

### some detective work

I don't even remember what I was looking for when I stumbled upon this mobo in ebay, but the twin Slot1/Socket370 config looked funky enough for me to click on the listing. It read *"ATA-N400-CX0 Dual Socket 370 & Slot 1 Motherboard Free Shipping"*, but after some googling of the model number I couldn't find much info about the maker.

Back in the day I used to see **PCChips** boards with a similar config, but they were based around a SiS chipset. I had never seen such a config with what seemed to be an Intel chipset, which is what struck me as curious. It also had 3 RAM slots and 2 ISA slots, which together hinted at it being based on the **i440BX**[^1].
...
{: refdef}
...and notice: the silkscreen has 2 as OOOO, the math above said its CCCC, and 9.5 should be OOOO. What's going on here? Simple: there is no 9.5 multiplier in the board. The logic in the motherboard includes multipliers from 2 to 9, including half-multipliers, and it identifies 2$\leftrightarrow$9.5, i.e., CCCC$\leftrightarrow$OOOO.

Not that it matters anyways, because Pentium*!!!* CPUs are multiplier-locked, meaning they get their multiplier from the CPU instead of the motherboard. So all of the above is *super* useless... except that there are some Pentium II CPUs which are multiplier unlocked. I don't *have* any, but I know they're out there.

I do have something which I think is better than an unlocked Pentium II:
{:refdef:}
![](/assets/img/2026-02-24-440bx_4.jpg){:width="70%"}
{:refdef}
A **Celeron 333 Engineering Sample** with unlocked multipliers.
...
{:refdef:}
![](/assets/img/2026-02-24-440bx_5.bmp){:width="70%"}
{:refdef}
